...
//   - payment: Domain payment to persist (ID will be auto-generated)
//
// Returns:
...
func (r *PaymentRepository) FindByUserID(ctx context.Context, userID string, limit, offset int) ([]domain.Payment, error) {
